...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-[70vh] lg:min-h-[80vh] bg-white">
      <div className="absolute inset-0">
        <Spline scene="https://prod.spline.design/xzUirwcZB9SOxUWt/scene.splinecode" style={{ width: '100%', height: '100%' }} />
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center min-h-[70vh] lg:min-h-[80vh]">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-white via-white/70 to-white/10" />
        <div className="relative z-10 max-w-2xl py-20 lg:py-28">
          <p className="uppercase tracking-widest text-xs text-neutral-600">Psychology Portfolio</p>
          <h1 className="mt-3 text-4xl sm:text-5xl font-semibold text-neutral-900 leading-tight">
            Farah Najwa
          </h1>
          <p className="mt-4 text-neutral-700 text-base sm:text-lg leading-relaxed">
            Aspiring psychology undergraduate with interests in cognitive science, research methods, and human behaviour.
          </p>
